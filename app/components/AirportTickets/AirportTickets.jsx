...
const TaxiPrices = () => {
  ...
  return (
    <section className="bg-white px-4  p-20 md:px-12">
      {/* Heading */}
      <h1
          className="  text-3xl  font-bold leading-[1.1] bg-clip-text text-[#0000FF]"
         
        >
         Popular routes and fares from Mykonos port
        </h1>
